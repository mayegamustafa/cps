        ...
        <div className="container-page grid gap-6 lg:grid-cols-[2.2fr_1fr]">
          <div className="overflow-hidden rounded-2xl border border-line bg-maroon-950">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-white/10 p-5 text-white">
              <div>
                <h2 className="text-xl !text-white">Morning Assembly, Live</h2>
                <p className="text-sm text-paper/60">Streaming now · 312 watching</p>
              </div>
              <button className="inline-flex items-center gap-1.5 rounded-full border border-white/25 px-4 py-2 text-sm hover:bg-white/10">
                <Icon name="arrow-up-right" size={16} /> Share
              </button>
            </div>
          </div>
