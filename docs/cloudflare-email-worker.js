/**
 * City Parents School — Cloudflare Email Worker
 * ---------------------------------------------
 * Receives mail for the school domain and posts it to the portal's webhook.
 *
 ...
 *   PORTAL_WEBHOOK_URL  https://<your-api-host>/api/mailbox/inbound
 *   PORTAL_SECRET       the secret from Admin, Mailbox, Setup
 *
